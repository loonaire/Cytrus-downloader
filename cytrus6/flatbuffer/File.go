...
func (rcv *File) MutateExecutable(n bool) bool {
...
func FileAddExecutable(builder *flatbuffers.Builder, executable bool) {
	builder.PrependBoolSlot(4, executable, false)
}
